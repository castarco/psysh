...
class Context
{
    ...
    {
        return array_merge($this->scopeVariables, $this->getSpecialVars());
    }
     ...
     * @return array
     */
    public function getSpecialVars()
    {
        $vars = array(
            '_' => $this->returnValue,
        );
     ...
     */
    public function setCommandScopeVars(array $commandScopeVariables)
    {
        $vars = array();
